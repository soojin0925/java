...
public class Class6 {
	public static void main(String[] args) {
		Car 아빠차 = new Car();
		//아빠차.name = "그랜저"; 			// private하면 직접 사용이 불가능해짐 (대입x)
...
/*
 접근권한 제어자 
 	...
 	protected : 다른 패키지에서 접근 불가능하지만 상속했을 경우네는 가능
...
class Car{
	...
	// 대입을 위해선 set
	public void setName(String name) { 		// public 메서드로 제공되지 않는 private변수는 대입이나 사용이 불가능 =>캡슐화
		this.name = name;
	}
